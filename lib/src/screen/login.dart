...
class _LoginState extends State<Login> {
  ...
  void _login() async{
    ...
    print("Test tombol login ditekan!k");
    var data = {
      'email' : email,
      'password' : password
    };
    ...
    if(body['success']){
      ...
      print("sebelum cek role ");
      if(body['role']=="admin") {
//        Navigator.push(
//          context,
//          new MaterialPageRoute(
//              builder: (context) => Admin.Home()
//          ),
//        );
